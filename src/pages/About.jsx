            ...
            <section className="mb-20">
                ...
                <div className="max-w-3xl mx-auto text-lg text-text-secondary leading-relaxed space-y-6">
                    ...
                    <div className="pt-4 flex justify-center md:justify-start">
                        <a href="/resume.pdf" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center px-6 py-3 bg-text-primary text-bg-surface font-medium rounded-none hover:bg-accent-color transition-colors duration-300">
                            Download Resume
            ...
            <section className="mb-20">
                ...
                <div className="flex flex-wrap justify-center gap-4 max-w-3xl mx-auto">
                    {['AI-Assisted Development', 'Agentic AI Frameworks', 'Machine Learning', 'SaaS Architecture', 'Automation & Bots', 'Embedded Systems & IoT', 'Robotics & Mechatronics'].map((interest, index) => (
                        <span key={index} className="px-4 py-2 bg-bg-surface rounded-none text-sm border border-border-color text-text-primary hover:border-text-primary transition-colors cursor-default">
                            {interest}
                        </span>
                    ))}
                </div>
